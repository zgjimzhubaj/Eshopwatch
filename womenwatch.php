...
<body>
   ...
   <br>
    ...
    <div class="text-center">
      <h4 class="showcase-h4">A girl should be two things: classy and fabulous!</h4>
</div>
  ...
  <div class="row">
    ...
    <?php
      $sql = "SELECT * FROM products WHERE type = 'Womenwatch'";
...
<div class="container">
      <div class="row">
         <div class="col-md-6  col-sm-12">
           <img src="images/pink.jpeg" style="width:100%; max-height: 800px;  ">
         </div>
        
         <div class="col-md-6  col-sm-12">
           <img src="images/ring.jpeg" style="width:100%; max-height: 800px;  ">
         </div>
  ...
  <div class="row">
    ...
    <?php
      $sql = "SELECT * FROM products WHERE type = 'Womenwatch1'";
      $query = mysqli_query($conn,$sql);
